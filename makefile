...
ifneq (,$(raylibtest_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f raylibtest.make config=$(raylibtest_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f raylibtest.make clean
